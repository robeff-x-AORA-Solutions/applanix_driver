            ...
            const bool & enable_ned2enu_transform)
{
    ...
    autowareOrientationMsg.orientation.rmse_rotation_x =
            covariance.attitude_rms.roll / 180.0f * static_cast<float>(M_PI);
    autowareOrientationMsg.orientation.rmse_rotation_y =
            covariance.attitude_rms.pitch / 180.0f * static_cast<float>(M_PI);
    autowareOrientationMsg.orientation.rmse_rotation_z =
            covariance.attitude_rms.heading / 180.0f * static_cast<float>(M_PI);
